package com.sinothk.widget.dragDeleteView;
 ...
 * 仿QQ消息数拖动删除.
 */
public class DragDeleteView extends AppCompatTextView {
    ...
    public DragDeleteView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }

    public DragDeleteView(Context context, AttributeSet attrs, int defStyleAttr) {
